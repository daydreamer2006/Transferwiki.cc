...
10. 比起自身条件，更重要的是尽早申请和complete。尽管截至日期很晚，但如果卡着ddl申请很可能因为UMN已经录了太多人而喜提rej或waitlist。
...
4. 语言成绩：TOEFL（79，写作21），IELTS（6.5，写作6.5），Doulingo（115，写作115）。通过官方渠道发送。
5. 小文书和活动列表（选填）。

## 重要日期

秋转ddl:2/1(priority) 6/1
春转ddl:10/1(priority) 12/1
...
参考材料：[Common Data Set 2023-2024](https://idr.umn.edu/sites/idr.umn.edu/files/cds_2023_2024_tc.pdf)
