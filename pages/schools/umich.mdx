...
- 尽管如此，勾选的专业也会影响录取结果，所以可以考虑避开热门专业。

- umich 近年加入了对cs的限制，所有转学生必须申请时就选择cs的 advanced selection才有机会转入，否则入学后无法内转。而勾选这个有概率不仅不被cs录取，甚至连文理学院都无法转入，所以要慎重考虑。

- 转学分较差，常常出现陆本两年只能转30分的情况
...
| --- | --- | --- | --- | ---|
| [21](https://www.usnews.com/best-colleges/university-of-michigan-ann-arbor-9092) | [19](https://www.shanghairanking.com/institution/university-of-michigan-ann-arbor) | [44](https://www.topuniversities.com/universities/university-michigan-ann-arbor) | [22](https://www.timeshighereducation.com/world-university-rankings/university-michigan-ann-arbor) | 6 |
...
5. 语言成绩：TOEFL，IELTS，MET，etc。可选：ACT/SAT（只有高中参加的成绩有效）。申请者可以自己报告考试的成绩。
